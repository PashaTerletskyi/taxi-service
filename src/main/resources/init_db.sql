...
CREATE TABLE taxi.drivers  (
                               ...
                               `license_number` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL UNIQUE,
...
DROP TABLE IF EXISTS taxi.manufacturers;
...
DROP TABLE IF EXISTS taxi.cars_drivers;
